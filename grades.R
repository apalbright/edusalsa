...
grades$Bminus<-grades$grade_distributions.B.
grades$Cminus<-grades$grade_distributions.C.
...
grades$Bplus<-grades$grade_distributions.B..1
grades$Cplus<-grades$grade_distributions.C..1
...
ggplot(grades1, aes(x=gr, y=freq))+ 
	geom_bar(stat="identity")+
	my_theme()+
  ggtitle(expression(atop(bold("Stanford Student Grades Histogram"), atop(italic("via Edusalsa.com & Alex Albright (thelittledataset.com)"),""))))+
  labs(x="Grades (Mean=3.50 & Median=3.67)", y="Frequency")+
...
a<-ggplot(hs, aes(x=gr, y=freq))+ 
	geom_bar(stat="identity")+
	my_theme()+
  ggtitle("School of Humanities & Sciences Grades Histogram")+
  labs(x="Grades (Mean=3.46 & Median=3.67)", y="Frequency")+
...
b<-ggplot(engr, aes(x=gr, y=freq))+ 
	geom_bar(stat="identity")+
	my_theme()+
  ggtitle("School of Engineering Grades Histogram")+
  labs(x="Grades (Mean=3.54 & Median=3.67)", y="Frequency")+
...
c<-ggplot(earth, aes(x=gr, y=freq))+ 
	geom_bar(stat="identity")+
	my_theme()+
  ggtitle("School of Earth, Energy and Environmental Sciences Grades Histogram")+
  labs(x="Grades (Mean=3.51 & Median=3.67) \n \n Visual via Edusalsa.com & Alex Albright (thelittledataset.com)", y="Frequency")+
